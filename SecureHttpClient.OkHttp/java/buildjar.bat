...
bitsadmin.exe /transfer "Download okhttp jar" https://repo1.maven.org/maven2/com/squareup/okio/okio/3.2.0/okio-3.2.0.jar "%~dp0\jars\okio.jar"
bitsadmin.exe /transfer "Download okhttp jar" https://repo1.maven.org/maven2/com/squareup/okio/okio-jvm/3.2.0/okio-jvm-3.2.0.jar "%~dp0\jars\okio-jvm.jar"
