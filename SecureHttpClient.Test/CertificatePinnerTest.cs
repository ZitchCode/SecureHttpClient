...
namespace SecureHttpClient.Test
{
    public class CertificatePinnerTest : TestBase, IClassFixture<TestFixture>
    {
        ...
        private static readonly string[] PinsOk = { @"sha256/nxlssfcOqwoVxiBMOc47kXV7ylLQCrYWt49L37DuCx4=" };
        ...
        private static readonly string[] Pins3Ok = { @"sha256/QXZd+SUr01R/fit9MKywkH37cuRuyTyos1HJezhHQD0=" };
